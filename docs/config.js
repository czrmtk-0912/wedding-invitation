/**
 * 招待状の文言・画像パス・GoogleフォームURL
 * GitHub Pages 公開前にここを編集してください。
 */
window.WEDDING_CONFIG = {
    googleFormUrl:
        "https://docs.google.com/forms/d/e/1FAIpQLSf8_QOyrLT44Djb2MBHI6s-vE8bi6hlSvAj6drOg33y9aHtEQ/viewform",
    ...
    labels: {
        menuSrOnly: "メニュー",
        navAriaLabel: "セクション一覧",
        heroScrollAriaLabel: "メッセージへスクロール",
        profileHeading: "新郎新婦紹介",
        storyHeading: "ふたりの写真",
        countdownHeading: "挙式まで",
        eventsHeading: "式のご案内",
        ceremonyTitle: "挙式",
        receptionTitle: "披露宴",
        venueTitle: "式場",
